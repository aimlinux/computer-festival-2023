...
def make_main():
    ...
    main_layout = [ [sg.Text('', size=(80, 1))], 
                ...
                [sg.Text('', size=(80, 1))],
                [sg.Button('アプリケーションを終了する', font=('Meiryo UI', 13), size=(30, 2), key='-exit-')]
    ]
...
def make_sub1():
    ...
    sub1_layout = [ [sg.Text('', size=(80, 1))],  
                ...
                [sg.Text('', size=(80, 1))],
                # 文章入力欄を設置
                [sg.Multiline('文字を入力してください', font=('Arial', 13), text_color='#191970', size=(70, 13), key='sentence_1')],
                [sg.Button('新単語生成', font=('Arial', 14), key='-generate_1-')], 
                [sg.Button('新単語を読み上げる', font=('Arial', 14), key='-speak_1-')],
                [sg.Output(size=(60, 8), font=('Arial'))], 
                [sg.Text('言語設定', font=('Arial', 14), text_color='#191970')],
...
def make_sub2():
    ...
    sub2_layout = [ [sg.Text('', size=(80, 1))],  
                ...
                [sg.Text('', size=(80, 2))],
                [sg.Button('新単語生成', font=('Arial', 14), key='-generate_2-')],
                [sg.Button('新単語を読み上げる', font=('Arial', 14), key='-speak_2-')],
                [sg.Output(size=(60, 12), font=('Arial'))],
                [sg.Text('', size=(80, 2))],
                [sg.Button('モード選択画面に戻る', font=('Arial', 13), size=(60, 1), key='-back-')],
...
def make_sub3():
    ...
    sub3_layout = [ [sg.Text('', size=(80, 1))],  
                ...
                [sg.Text('', size=(80, 2))],
                [sg.Button('新単語生成', font=('Arial', 14), key='-generate_3-')],
                [sg.Button('新単語を読み上げる', font=('Arial', 14), key='-speak_3-')],
                [sg.Output(size=(60, 12), font=('Arial'))],
                [sg.Text('', size=(80, 2))],
                [sg.Button('モード選択画面に戻る', font=('Arial', 13), size=(60, 1), key='-back-')],
    ]    
...
def make_sub4():
    ...
    sub4_layout = [ [sg.Text('', size=(80, 1))],  
                ...
                [sg.Text('', size=(80, 2))],
                [sg.Button('新単語生成', font=('Arial', 14), key='-generate_4-')],
                [sg.Button('新単語を読み上げる', font=('Arial', 14), key='-speak_4-')],
                [sg.Output(size=(60, 12), font=('Arial'))],
                [sg.Text('', size=(80, 2))],
                [sg.Button('モード選択画面に戻る', font=('Arial', 13), size=(60, 1), key='-back-')],
    ]    
...
def make_sub5():
    ...
    sub5_layout = [ [sg.Text('', size=(80, 1))],  
                ...
                [sg.Text('', size=(80, 2))],
                [sg.Button('新単語生成', font=('Arial', 14), key='-generate_5-')],
                [sg.Button('新単語を読み上げる', font=('Arial', 14), key='-speak_5-')],
                [sg.Output(size=(60, 12), font=('Arial'))],
                [sg.Text('', size=(80, 1))],
