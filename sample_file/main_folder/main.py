...
def img_1():
    img_1_layout = [
        [sg.Image(filename='img/img_1.png')]
    ]
...
def img_2():
    img_2_layout = [
        [sg.Image(filename='img/img_2.png')]
    ]
...
def img_3():
    img_3_layout = [
    [sg.Image(filename='img/img_3.png')]
    ]
...
def img_4():
    img_4_layout = [
        [sg.Image(filename='img/img_4.png')]
    ]
...
def img_5():
    img_5_layout = [
        [sg.Image(filename='img/img_5.png')]
    ]
